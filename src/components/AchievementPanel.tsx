...
export const AchievementPanel = ({ unlocked }: AchievementPanelProps): React.JSX.Element => (
  <section className="achievement-panel rounded-[1.6rem] border border-sky-200/24 bg-[rgba(7,18,34,0.8)] p-5 text-slate-50 shadow-[0_24px_56px_-34px_rgba(7,18,34,0.94)]">
